...
describe('Test parsing a definition line', () => {
    test('Parse a definition line', () => {
        let item = new DefinitionLine().parse('00001740-a	ind:def	memiliki sarana yang diperlukan')
        ...
        item = new DefinitionLine().parse('12477583-n	ind:def	tumbuhan, tinggi hingga 2 m, daunnya berukuran 1–2 m, berwarna hijau tua kebiru-biruan berduri tajam pada tepi dan ujungnya dan mengandung serat yang diolah dijadikan tenunan; nanas betawi')
        ...
        item = new DefinitionLine().parse('01358259-n	ind:def	bakteri fotosintetik ditemukan di air tawar dan air asin; ganggang yang berwarna biru atau biru kehijau-hijauan, di antaranya digunakan sebagai makanan alami utama bagi ikan bandeng di tambak air payau')
